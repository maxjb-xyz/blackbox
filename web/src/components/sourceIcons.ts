...
export type SourceIconSpec =
  | { kind: 'brand'; name: 'docker' | 'uptime-kuma' | 'watchtower' | 'proxmox' }
...
const SOURCE_CARD_COLORS: Record<string, SourceCardColors> = {
  ...
  proxmox:             { border: '#5a2a2a', bg: '#281414', text: '#e57000', topBar: 'linear-gradient(90deg,#7a3a3a,transparent 60%)' },
...
const SOURCE_ICON_SPECS: Record<string, SourceIconSpec> = {
  ...
  proxmox: { kind: 'brand', name: 'proxmox' },
